...
<header class="bg-light px-2 px-lg-5">
	...
	<nav class="navbar navbar-expand-md bg-body-tertiary">
		...
		<div class="container-fluid">
			<a
				class="col-3 col-lg-4 navbar-brand  hover-scale-1 d-flex gap-1"
				href="/">
				<img alt="GitHub" src="./images/icons/logoicon.png">
			...
			<div class="d-none d-md-block">
				<div class="dropdown d-none d-md-flex" id="btn-account">
					<button class="ms-auto rounded-pill px-3 border-light-green dropdown-toggle" type="button"
						...
						<img src="./images/icons/account.png" alt="Account Icon" class="py-1">
					</button>
