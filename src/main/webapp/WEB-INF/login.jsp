...
<main class="px-2 px-md-0 bg-lightgreen-fullscreen d-md-flex align-items-center gap-2">
	...
	<div
		...
		<div class="my-auto h-fit w-100 w-md-75 d-md-flex flex-md-column gap-3">
			<div>
				<h1 class="text-dark fw-semibold">Iniciar sesión</h1>
			...
			<form action="/login" method="POST" class="w-100 d-flex flex-column gap-3">
				...
				<div>
					<label for="inputPass" class="fw-semibold">Contraseña:</label>
					<div class="w-100 pb-2 border-bottom-light-brown d-flex gap-2">
			...
			<p class="mt-3 mx-auto text-center fw-semibold">
				¿No tenés una cuenta?
				<a href="/registration" class="text-medium-green fw-bold">¡Registrate hoy!</a>
			</p>
		</div>
	</div>
